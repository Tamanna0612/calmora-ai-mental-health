...
const MusicTherapy = {
    ...
    tracks: {
        'nature': { name: 'Nature Sounds', url: "frontend/music/Nature sounds.mp3" },
        'ocean': { name: 'Ocean Waves', url: "frontend/music/ocean waves.mp3" },
        'meditation': { name: 'Meditation', url:"frontend/music/focus.mp3"},
        'rain': { name: 'Rain Sounds', url: "frontend/music/rain.mp3" },
        'piano': { name: 'Calm Piano', url: "frontend/music/piano.mp3" },
        'white-noise': { name: 'White Noise', url: "frontend/music/forest.mp3" }
    },
